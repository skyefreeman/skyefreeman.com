---
layout: post
title: "Things you shouldn't do when building a startup"
date: "July 27, 2023"
author: Skye Freeman
...
So yeah, this one is self explanatory. [Swift Starter Kits](https://swiftstarterkits.com) went through several product phases, each time pivoting the product and its messaging to reduce scope and increase focus. The biggest marketing page rework was in March, when search traffic had surpassed thousands of visits per month (small, but a meaningful uptick). This was when I removed Firebase as a dependency and stopped marketing the kit as being a "Firebase enabled iOS starter kit", instead focusing on subscription revenue tooling and a faster out of the box experience.

Turns out most of the [Swift Starter Kits](https://swiftstarterkits.com) site traffic was looking for a Firebase enabled starter kit, traffic has gone down to the lower hundreds /month as of July.

## Change the product's name

This change was subtle, but around April I went through all of the [Swift Starter Kits](https://swiftstarterkits.com) web pages, and changed every reference of "SwiftStarterKits" to "Swift Starter Kits". This actually may have been a good move, but time will tell. 

My thinking was this: If somebody is searching for the term "SwiftStarterKits" (one word, no spaces), they already know what they are looking for and the domain will rank for this automatically. But changing all URL references over to "Swift Starter Kits" (3 words, with spaces) makes clear the intent that this is an actual query that I'd like to rank for. I want the site to broadcast "hey, if you're looking for a starter kit for Swift and SwiftUI, you may want what I built". This was the entire idea around the domain name [Swift Starter Kits](https://swiftstarterkits.com) in the first place.

What's interesting though, is that while traffic has decreased overall, [Swift Starter Kits](https://swiftstarterkits.com) now ranks in the top three for "Swift Starter Kit" and "Swift Starter Kits", which it wasn't before. 

## Learn about The Long Tail after building a product

Tongue in cheek aside. I read [The Long Tail](https://www.goodreads.com/book/show/2574) in April, after reading about its insights from [patio11's treasure trove of startup essay's](https://kalzumeus.com) (seriously, if you're serious about building internet startups and want to learn about internet marketing, you should start at the beginning of his journey in the early 2010's and print every blog post onto physical paper, and read until you're done). 
